 ...
 * 
 * @version 4.0
 * Updated AbstractTable class to use a list of Abstract Rows instead of an array of AbstractRows
 * Updated CityTable and StadiumTable classes to use ArrayList object instead of an Array
 * AbstractTable also uses generics now and extends AbstractRow
 */
...
public class Assign5Main {
	...
	public static void main(String[] args) {
		...
		AbstractTable<AbstractRow> myCityTable = new CityTable();
		AbstractTable<AbstractRow> myStadTable = new StadiumTable();
